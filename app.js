...
function exportSelectedToPDF() {
    ...
    <body>
            ...
            <div class="card">
                ...
                <div style="flex:1;">
                    ...
                    <div class="meta">
                        <span class="fine">Πρόστιμο: ${typeof v.fine === 'number' ? v.fine + '€' : v.fine}</span>
                        ${v.offloader_fine ? `<span class="offloader">Υπεύθ. φόρτωσης: +${v.offloader_fine}€</span>` : ''}
                        ${v.suspend && v.suspend !== '-' ? `<span>Κύρωση: ${v.suspend}</span>` : ''}
                        ${v.points > 0 ? `<span>Βαθμοί ΣΕΣΟ: ${v.points}</span>` : ''}
                    </div>
                </div>
            </div>
        `).join('')}
        ...
        <div class="summary">
            <h2 class="section-title">Σύνοψη</h2>
            <table>
                ...
                <tr class="total-row"><td class="label">Σύνολο Βαθμών ΣΕΣΟ</td><td class="value">${totalPoints} βαθμοί</td></tr>
            </table>
        </div>

        <div class="fillin">
            <h2 class="section-title">Στοιχεία Οδηγού / Οχήματος</h2>
            <div class="fillin-grid">
                <div class="fillin-line">Ονοματεπώνυμο: <span class="underline"></span></div>
                <div class="fillin-line">Αρ. Ταυτότητας / Διαβατηρίου: <span class="underline"></span></div>
                <div class="fillin-line">Αριθμός Κυκλοφορίας: <span class="underline"></span></div>
                <div class="fillin-line">Άδεια Οδήγησης Αρ.: <span class="underline"></span></div>
            </div>
            <div class="signatures">
                <div class="sig-box"><div class="sig-line">Υπογραφή Βεβαιούντος Οργάνου</div></div>
                <div class="sig-box"><div class="sig-line">Υπογραφή / Παρατηρήσεις Παραβάτη</div></div>
            </div>
        </div>

        <div class="disclaimer">
            Το παρόν αποτελεί βοηθητικό σημείωμα καταγραφής και δεν υποκαθιστά το επίσημο έντυπο βεβαίωσης παράβασης. Τα στοιχεία πρέπει να επαληθεύονται με τις ισχύουσες διατάξεις του Κ.Ο.Κ.
            <div class="footer-app">Δημιουργήθηκε με ΚΟΚ Τσέπης${typeof APP_VERSION !== 'undefined' ? ' v' + APP_VERSION : ''} — Πατήστε Ctrl+P ή «Εκτύπωση» για αποθήκευση ως PDF.</div>
        </div>

        <div class="no-print" style="text-align:center;margin-top:26px;">
            <button onclick="window.print()" style="padding:10px 30px;background:#0B2A4A;color:#fff;border:none;border-radius:8px;font-size:16px;cursor:pointer;">Εκτύπωση / Αποθήκευση ως PDF</button>
        </div>
    </body>
    </html>
    `;
